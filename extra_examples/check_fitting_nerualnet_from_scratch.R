### create our own 2 input neural network, generate data, and then fit
### the neural network using optim(). calculate the gradient with
### numDeriv::grad() and compare the fitting between the default optim()
### gradient and the more precise numDeriv::grad() version
...
### use the hyperbolic tangent so to demonstrate something different from the homework
Hgrid <- tanh(Agrid)
