...
### reviews the key steps performed when training and evaluating
### modeling with cross-validation
###
### manually performs the key steps that occur behind the scenes
### when we use caret
...
### define a function that performs all actions within a given resample fold
...
### alternatively, we could consider using more PC features and applying
### regularization with lasso. The regularization strength would then
### need to be tuned with cross-validation instead of the number of
### PCs to retain since lasso would be turning off the unimportant
### PC features for us
